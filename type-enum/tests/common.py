...
class CustomTestCase(TestCase):
    def assertIsSubclass(self, cls: type, parent_cls: _ClassInfo, msg: Any = None) -> None:
    ...
    def assertNotIsSubclass(self, cls: type, parent_cls: _ClassInfo, msg: Any = None) -> None:
